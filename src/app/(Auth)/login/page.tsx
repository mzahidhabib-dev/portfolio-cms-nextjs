  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-10 text-center">
        ...
        <h2 className="text-3xl font-bold tracking-tight text-foreground">System Access</h2>
        <p className="text-muted-foreground text-[10px] mt-2 uppercase tracking-[0.4em] font-bold opacity-70">Identify Yourself</p>
      </div>

      <form onSubmit={handleLogin} className="space-y-5">
        <div className="space-y-2">
          <label className="text-[10px] font-bold uppercase text-muted-foreground/80 ml-1 tracking-widest">Identity</label>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center px-1">
            <label className="text-[10px] font-bold uppercase text-muted-foreground/80 tracking-widest">Access Key</label>
            <Link href="/reset-password" data-name="reset" className="text-[10px] text-primary font-bold hover:underline uppercase tracking-tighter">Forgot Key?</Link>
          </div>
          <div className="relative group">
        ...
        >
          {isLoading ? <Loader2 className="animate-spin size-5" /> : (
            <>Authorize Access <ChevronRight className="ml-2 size-5 group-hover:translate-x-1 transition-transform" /></>
          )}
        </Button>
      </form>
    </motion.div>
