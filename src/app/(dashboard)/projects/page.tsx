...
export default function ProjectsPage() {
  ...
  const handleAddOrUpdateProject = () => {
    ...
    const techArray = data.projectTech
      ? data.projectTech
          .split(",")
          .map((t) => t.trim())
          .filter((t) => t !== "")
    ...
    if (editingId) {
      setProjectsList((prev) =>
        prev.map((p) =>
          p.id === editingId ? { ...projectData, id: p.id } : p,
        ),
      );
      setEditingId(null);
    ...
    <Form {...form}>
      <div className="space-y-8 pb-24 px-4 sm:px-0">
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {projectsList.map((project) => (
                  <div
                    key={project.id}
                    className="group relative rounded-xl border bg-card overflow-hidden shadow-sm hover:shadow-md transition-all h-fit"
                  >
                    {deleteId === project.id && (
                      <div className="absolute inset-0 z-20 bg-destructive/95 flex flex-col items-center justify-center p-4 text-center animate-in fade-in zoom-in duration-200">
                        ...
                        <p className="text-white text-[10px] font-bold uppercase mb-4 tracking-widest">
                          Delete Project?
                        </p>
                    ...
                    <div className="p-4 space-y-2">
                      ...
                      <div className="flex flex-wrap gap-1 pt-2">
                        {project.tech.map((t, i) => (
                          <span
                            key={i}
                            className="text-[8px] bg-secondary text-secondary-foreground px-1.5 py-0.5 rounded font-bold uppercase tracking-wider"
                          >
                            {t}
                          </span>
                        ))}
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div
                  ...
                  className="relative border-2 border-dashed rounded-xl overflow-hidden aspect-video flex flex-col items-center justify-center gap-2 hover:bg-muted/50 transition-all cursor-pointer bg-muted/20"
                >
                  {projectImage ? (
                    <>
                      <img
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 bg-destructive text-white rounded-full p-1 shadow-md hover:scale-110"
                      >
                        <X className="size-3" />
                      </button>
                    </>
                    ...
                    <div className="text-center">
                      <Upload className="size-5 text-muted-foreground mx-auto mb-1" />
              ...
              <div className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Chat App" {...field} />
                      </FormControl>
                    </FormItem>
                  )}
                />
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs">Demo</FormLabel>
                        <FormControl>
                          <Input placeholder="Link" {...field} />
                        </FormControl>
                      </FormItem>
              ...
              <Button
                ...
                className="w-full gap-2 font-bold uppercase text-xs tracking-widest"
              >
                {editingId ? (
        ...
        <div className="fixed bottom-8 right-8 z-50">
          <Button
            onClick={form.handleSubmit(onSaveSection)}
            size="lg"
            className="rounded-full shadow-2xl gap-2 px-10 h-14 font-bold"
          >
