  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      message: "I need a MERN stack developer.",
      status: "pending",
      date: "2026-03-17",
    },
  ]);
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b pb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Manage client inquiries and customize your contact form.
          </p>
        </div>
      </div>
                ...
                {messages.map((m) => (
                  ...
                  >
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      <Badge
                        variant={
                          m.status === "pending" ? "outline" : "secondary"
                        }
                        className={cn(
              ...
              {selectedMsg ? (
                <div className="rounded-xl border bg-card shadow-sm flex flex-col h-full min-h-[500px]">
                  ...
                  <div className="p-6 border-t bg-muted/10 flex flex-wrap gap-3">
                    ...
                    <Button
                      className="ml-auto gap-2 px-8 font-bold h-9 shadow-md"
                      onClick={() =>
                        window.open(
                          `mailto:${selectedMsg.email}?subject=RE: ${selectedMsg.subject}`,
                        )
                      }
                    >
          ...
          <Form {...form}>
            <div className="flex justify-end mb-4">
              <Button
                ...
                className="gap-2 text-xs font-bold hover:bg-destructive/5 hover:text-destructive"
              >
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="space-y-6">
                <div className="p-6 border rounded-xl bg-card space-y-5 shadow-sm">
                  <h3 className="font-bold flex items-center gap-2 border-b pb-3">
                    <Type className="size-4 text-primary" /> Frontend Visuals
                  </h3>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g. Let's Talk" {...field} />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                ...
                <div className="p-6 border rounded-xl bg-card space-y-4 shadow-sm">
                  <h3 className="font-bold flex items-center gap-2 border-b pb-3">
                    <ImageIcon className="size-4 text-primary" /> Section
                    Graphic
                  </h3>
                  <div
                    onClick={() =>
                      document.getElementById("contact-img-upload")?.click()
                    }
              ...
              <div className="space-y-6">
                <div className="p-6 border rounded-xl bg-card space-y-5 shadow-sm">
                  <h3 className="font-bold flex items-center gap-2 border-b pb-3">
                    <Globe className="size-4 text-primary" /> Logic &
                    Confirmation
                  </h3>
                  <FormField
                    control={form.control}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="https://api/domain.com/messages"
                            {...field}
                          />
                        </FormControl>
                      </FormItem>
                ...
                <Button
                  ...
                  size="lg"
                  className="rounded-full w-full gap-3 font-bold h-14 shadow-xl text-md"
                >
